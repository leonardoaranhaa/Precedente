...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DyihRYWV.mjs");
...
var manifest = { "c7aade2d1da73c515095d432d3d5ae2dda909eab2e45307ca8affe90d119707c": {
	functionName: "analyzeSetup_createServerFn_handler",
	importer: () => import("./analyze-CSfx1EQm.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-PzFx8B7D.mjs").then((n) => n.t),
