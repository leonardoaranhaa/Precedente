...
export function matchesPreferences(item: NewsItem, prefs: NewsPreferences): boolean {
...
export function filterNewsForPreferences(items: NewsItem[], prefs: NewsPreferences): NewsItem[] {
